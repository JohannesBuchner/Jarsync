...
public class Options {
   ...
   static {
      CAPABILITIES = UnixSystem.getCapabilities();
   }
   ...
   public int
   parseArguments(String progname, String[] argv, PrintStream err)
   throws IllegalArgumentException
   {
      ...
      switch (c) {
         ...
         case 'H':
            if (!CAPABILITIES.getBooleanProperty(
                 Capabilities.HARD_LINK_SUPPORTED))
         ...
         case 'a':
            recurse = true;
            if (CAPABILITIES.getBooleanProperty(
                Capabilities.SYMBOLIC_LINK_SUPPORTED))
               preserve_links = true;
            preserve_perms = true;
            preserve_times = true;
            preserve_uid = true;

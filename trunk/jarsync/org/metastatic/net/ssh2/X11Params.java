...
// $Id$
//
// X11Params -- Parameters for accepting X11 forwardings.
...
final class X11Params {

   // Constants and fields.
   // -----------------------------------------------------------------------

   /** The fake cookie that the server sends when connecting. */
   String fake_cookie;

   /** The real authentication cookie. */
   String cookie;

   /** True if only a single connection is accepted. */
   boolean single_connection;

   /** True if we are still accepting connections. */
   boolean accepting;
}
